...
* @returns {string}
*/
export function parse_tb64(tb64) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(tb64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.parse_tb64(retptr, ptr0, len0);
...
* @returns {string}
*/
export function encode_tb64(tag, value) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.encode_tb64(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {string}
*/
export function to_string(tb64) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(tb64, TaggedBase64);
        wasm.to_string(retptr, tb64.__wbg_ptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export class JsTaggedBase64 {
    ...
    free() {
        ...
        wasm.__wbg_jstaggedbase64_free(ptr);
    }
    /**
    * @param {string} tag
    ...
    */
    constructor(tag, value) {
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            wasm.jstaggedbase64_new(retptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    static parse(tb64) {
        try {
            ...
            const ptr0 = passStringToWasm0(tb64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.jstaggedbase64_parse(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    tag() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jstaggedbase64_tag(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    value() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jstaggedbase64_value(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set_tag(tag) {
        const ptr0 = passStringToWasm0(tag, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.jstaggedbase64_set_tag(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    set_value(value) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.jstaggedbase64_set_value(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    to_string() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jstaggedbase64_to_string(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class TaggedBase64 {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TaggedBase64.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_taggedbase64_free(ptr);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('tb64_wasm_shim_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
