...
export interface InitOutput {
  ...
  readonly parse_tb64: (a: number, b: number, c: number) => void;
  readonly encode_tb64: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly __wbg_taggedbase64_free: (a: number) => void;
  readonly __wbg_jstaggedbase64_free: (a: number) => void;
  readonly to_string: (a: number, b: number) => void;
  readonly jstaggedbase64_new: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly jstaggedbase64_parse: (a: number, b: number, c: number) => void;
  readonly jstaggedbase64_tag: (a: number, b: number) => void;
  readonly jstaggedbase64_value: (a: number, b: number) => void;
  readonly jstaggedbase64_set_tag: (a: number, b: number, c: number) => void;
  readonly jstaggedbase64_set_value: (a: number, b: number, c: number) => void;
  readonly jstaggedbase64_to_string: (a: number, b: number) => void;
